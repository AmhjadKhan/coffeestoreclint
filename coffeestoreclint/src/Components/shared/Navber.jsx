...
const Navber = () => {
  ...
  <div className="navbar-start">
    ...
    <div className="flex">
        <img className="h-12 w-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQS2nPmTCZXdkGeutYrA_R4gXC2v7UGAvi7GPJpwTMdb5yNRsPFRablpUh4AhEypVVCmMY&usqp=CAU" alt="" />
